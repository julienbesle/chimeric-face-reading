...
### Analysis folder contains R scripts used to run analyses and produce corresponding manuscript figures
...
### Data folder contains compiled single-trial data files
